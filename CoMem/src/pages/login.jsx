  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        handleLogin(result.user); // Cập nhật context với thông tin user
        navigate("/");
      } else {
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg w-[400px] border border-gray-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <button type="submit" className="bg-green-700 text-white px-6 py-3 rounded-md hover:bg-green-800 transition-all">
                Đăng nhập
              </button>
            </div>
          </form>
